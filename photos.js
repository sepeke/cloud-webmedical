...
/* add src values to img element based on order specified in photoOrder array */
function populateFigures() {
	var filename;
	var currentFig;
	if (figureCount === 3) {
		for (var i = 1; i < 4; i++) {
			filename = "images/IMG0" + photoOrder[i] + "sm.jpg";
...
function previewFive() {
	...
	//create figure and img elementsfor fifth
	var lastFigure = document.createElement("figure");
	lastFigure.id = "fig5";
	lastFigure.style.zIndex = "5";
	lastFigure.style.position = "absolute";
	lastFigure.style.right = "5px";
...
//	articleEl.appendChild(lastFigure);
	...
	// clone figure element for fifth image and edit to be for first image
...
//	articleEl.appendChild(firstFigure);
	...
	document.getElementsByTagName("img")[0].src = "images/IMG0" + photoOrder[0] + "sm.jpg";
	document.getElementsByTagName("img")[4].src = "images/IMG0" + photoOrder[4] + "sm.jpg";
